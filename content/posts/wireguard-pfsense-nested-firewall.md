...
draft: false
description: "Raw WireGuard on pfSense, reached from my phone on mobile data. The tunnel was the easy part. Then four silent failures, same symptom, four different layers."
...
![DDNS entry green and tracking the public IP](/images/posts/wireguard-ddns-working.png)
...
![WireGuard tunnel created — service not yet running](/images/posts/wireguard-tunnel-created.png)
...
![Peer configuration on pfSense](/images/posts/wireguard-peer-config.png)
...
![Router port-forward for WireGuard](/images/posts/wireguard-port-forward.png)
...
![Latest handshake — the tunnel is up over mobile data](/images/posts/wireguard-phone-handshake.png)
...
![tcpdump: SYN arrives, no reply — silent drop](/images/posts/wireguard-tcpdump-no-reply.png)
...
![The hidden nftables policy-drop chain](/images/posts/wireguard-nftables-drop.png)
...
![The 10.20.20.0/24 route finally present, via the tunnel](/images/posts/wireguard-route-fixed.png)
