...
draft: false
description: "Three firewall-isolated segments — Trusted, IoT and Guest — built entirely in virtual machines with no managed-switch hardware, and proof the isolation holds."
